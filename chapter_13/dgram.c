/* dgram.c
 * support function for datagram based programs
 */
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
...
int get_interntet_address(char * host,int len,int * portp, struct sockaddr_in *addrp)
