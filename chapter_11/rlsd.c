...
int main(int ac, char *av[])
{
	...
	struct hostent  *hp；			//this is a part of our
	char hostname[HOSTLEN];			//address
	int sock_id,sock_fd;			//line id,file desc
	FILE *sock_fpi, *sock_fdo;		//streams for in and out 
	...
	bzero((void *)&saddr, sizeof(saddr));	//clear our struct
...
// and we naively created a command "ls ; rm *"
//so..we remove everythingbut slashes and alphanumerics
//There are nicer solutions,see execrcises
{
	char *src, *dest;
